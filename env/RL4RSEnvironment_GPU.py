...
from env.RL4RSEnvFeedback import RL4RSEnvFeedback
from env.BaseRLEnvironment import BaseRLEnvironment


class RL4RSEnvironment_GPU(BaseRLEnvironment):
    @staticmethod
    def parse_model_args(parser):
        '''
        args:
        - env_feedback_model_path
        ...
        parser.add_argument('--env_feedback_model_path', type=str, help='log path for saved user response model')
    ...
    def __init__(self, args):
        super(RL4RSEnvironment_GPU, self).__init__(args)
        self.temper_sweet_point = args.temper_sweet_point
        self.temper_prob_lag = args.temper_prob_lag
        
        env_feedback_model_log_path = "env/rl4rs/log/env_feedback_model.log" 
        env_feedback_model_path = "env/rl4rs/env_feedback_model"

        infile = open(env_feedback_model_log_path, 'r')
        ...
        self.user_response_model = RL4RSEnvFeedback(model_args, self.reader, args.device)
        self.user_response_model.load_from_checkpoint(env_feedback_model_path, with_optimizer = False)

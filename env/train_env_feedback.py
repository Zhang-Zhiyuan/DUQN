...
import argparse
import numpy as np
from RL4RSEnvFeedback import RL4RSEnvFeedback
from RL4RSDataReader import RL4RSDataReader
import os
import utils
...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--model', type=str, default='RL4RSEnvFeedback', help='User response model class.')
    ...
    print(initial_args)
    modelClass = RL4RSEnvFeedback
    readerClass = RL4RSDataReader
    
    # control args
    parser = argparse.ArgumentParser()
    parser.add_argument('--seed', type=int, default=9, help='random seed')
    parser.add_argument('--batch_size', type=int, default=2048, help='batch size') #test set size 5 ; original set size 128

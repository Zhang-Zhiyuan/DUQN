...
class RL4RSDataReader(BaseReader):
    ...
    def parse_data_args(parser):
        ...
        parser.add_argument('--item_meta_file', type=str,default='dataset/rl4rs/item_info.csv', 
    ...
    def _read_data(self, args):
        ...
        self.item_vec_size = 40#len(eval(self.item_meta.iloc[0]['item_vec']))
        self.portrait_len = len(eval(self.data['train']['user_protrait'][0]))
        # if True :
        #     self.data['train'] = self.data['val']
    ...
    def __getitem__(self, idx):
        ...
        # print("history_length", hist_length)
        # print("record(history)",record["history"].shape)

                ...
                do
                    ...
                    do
                        ...
                        python test_rl_agent.py\
                            ...
                            --topk_rate ${TOPK}\
                            --test\
                            > ${output_path}agents/hac_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_behave${BEHAVE_LR}_hacoef${HA_COEF}_niter50000_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_topk${TOPK}_seed${SEED}/test_log                                                       
                    done
                done
            done
        done

                ...
                do
                    ...
                    do
                        ...
                        python train_rl_agent.py\
                            ...
                            --check_episode 10\
                            --topk_rate ${TOPK}\
                            > ${output_path}agents/online_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_behave${BEHAVE_LR}_niter50000_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                    done
                done
            done
        done
